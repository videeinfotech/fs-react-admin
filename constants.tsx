...
export const NAV_LINKS: NavLinkInfo[] = [
    ...
    { name: 'Monitoring', path: '/admin/monitoring', icon: <MonitoringIcon /> },
    { name: 'Users', path: '/admin/users', icon: <UsersIcon /> },
    { name: 'Listeners', path: '/admin/listeners', icon: <ListenersIcon /> },
    { name: 'Wallet', path: '/admin/wallet', icon: <WalletIcon /> },
    { name: 'Sessions', path: '/admin/sessions', icon: <SessionsIcon /> },
    { name: 'Live Sessions', path: '/admin/live-sessions', icon: <LiveIcon /> },
    ...
    { name: 'Support Tickets', path: '/admin/tickets', icon: <TicketsIcon /> },
