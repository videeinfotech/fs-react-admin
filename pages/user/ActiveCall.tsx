    ...
    return (
        <div className="flex flex-col h-screen bg-gray-800 text-white items-center justify-between p-8">
            ...
            <div className="text-center">
                <img src={user.avatarUrl} alt={user.name} className="w-32 h-32 rounded-full mx-auto border-4 border-primary-400" />
            ...
            <div className="flex items-center space-x-6">
                ...
                <button onClick={() => endCall('user', sessionId || '')} className="p-5 bg-red-600 rounded-full hover:bg-red-700">
                    {/* End Call Icon */}
