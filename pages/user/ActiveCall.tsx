...
const ActiveCall: React.FC = () => {
    ...
    // Extract listener ID from session ID for demo
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-800 text-white items-center justify-between p-8">
            <div className="absolute top-4 right-4 w-24 h-32 bg-gray-700 rounded-lg shadow-lg">
                {/* Local user video preview would go here */}
            </div>
            ...
            <div className="flex items-center space-x-6">
                ...
                <button onClick={() => navigate(`/user/call-summary/${sessionId}`)} className="p-5 bg-red-600 rounded-full hover:bg-red-700">
