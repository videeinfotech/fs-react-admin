...
export const ListenerNavbar: React.FC<NavbarProps> = ({ toggleSidebar }) => {
  return (
    <nav className="fixed top-0 z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 sm:ml-64">
          ...
          <div className="flex items-center">
            <div className="flex items-center ml-3">
              ...
              <div className="flex items-center ml-4">
                  <span className="mr-3 text-sm font-semibold text-gray-900 dark:text-white">Listener Name</span>
                   <img src="https://i.pravatar.cc/150?u=1" alt="Listener" className="w-8 h-8 rounded-full" />
              </div>
            </div>
          </div>
        </div>
